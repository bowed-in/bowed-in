...
test.only('Test the search posting page', async (testController) => {
  ...
  await searchPage.selectSearchBar(testController);
  await searchPage.selectAddButton(testController);
});
...
/* *************************************** List Student Page ************************************************ */
test('Test that the List Student page shows up', async (testController) => {
  await navBar.gotoSigninPage(testController);
  await signinPage.signin(testController, companyCred.username, companyCred.password);
