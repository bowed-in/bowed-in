    ...
    return (
      <Menu style={menuStyle} attached="top" borderless>
        ...
        {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
          <Menu.Item as={NavLink} activeClassName="" exact to="/adminhome">
            <Header as='h1' style={greenText}>BowedIn</Header>
          </Menu.Item>
        ) : ''}
        ...
        {this.props.currentRole === 'company' ?
          (
            <Menu.Item style={greenText} as={NavLink} activeClassName="" exact to="/liststudents" id="recruit">
              Recruit Students
            </Menu.Item>
          ) : ''}
        ...
        {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
          [
            ...
            <Menu.Item id="admin-position" as={NavLink} activeClassName="active" exact to="/positionadmin" key='admin'>List Positions Admin</Menu.Item>,
          ]
        ) : ''}
